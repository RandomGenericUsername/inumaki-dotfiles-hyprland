...
# Path to create_cookiecutter_context script
export create_cookie_cutter_context=$lib/create_cookiecutter_context.sh

export cookiecutter_template_json=$__script_dir/dotfiles-template/cookiecutter.json
...
source $create_cookie_cutter_context